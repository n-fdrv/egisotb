...
def download_schedule_data(request, pk):
    ...
    writer = csv.writer(response, delimiter=';', quotechar='"', quoting=csv.QUOTE_ALL, escapechar='\\')

    headers = [
        'surname', 'name', 'patronymic', 'birthday', 'docType', 'docNumber',
        'route', 'departPlace', 'arrivePlace', 'departDate', 'arriveDate',
        'routeType', 'citizenship', 'gender', 'recType', 'rank',
        'operationType', 'operatorId', 'places', 'seatsCount', 'buyDate',
        'shipClass', 'shipNumber', 'shipName', 'flagState', 'registerTimeIS',
        'operatorVersion', 'phoneNumber', 'email', 'accountLogin',
        'accountPasswordHash', 'internetInformation', 'payInfoOrganization',
        'payInfoAccountNumber', 'ticket', 'amount', 'currency', 'travelClass',
        'speId', 'gpeId'
    ]
