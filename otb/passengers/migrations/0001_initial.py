    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=100, unique=True, verbose_name='Гражданство')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pk_for_file', models.PositiveIntegerField(unique=True, verbose_name='Уникальный номер (для файла)')),
            ],
            options={
