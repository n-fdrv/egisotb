    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(max_length=100, verbose_name="Название парома"),
                ),
                (
                    "registration_number",
                    models.CharField(
                        max_length=50,
                        unique=True,
                        verbose_name="Регистрационный номер судна",
                    ),
                ),
                (
                    "ship_class",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "is_active",
                    models.BooleanField(default=True, verbose_name="На смене"),
                ),
                (
                    "created_at",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(max_length=100, verbose_name="Название рейса"),
                ),
                (
                    "departure_port",
                    models.CharField(max_length=100, verbose_name="Пункт отправления"),
                ),
                (
                    "arrival_port",
                    models.CharField(max_length=100, verbose_name="Пункт прибытия"),
                ),
                ...
                (
                    "route_type",
                    models.CharField(
                        choices=[("0", "Беспересадочный"), ("1", "Транзитный")],
                        max_length=1,
